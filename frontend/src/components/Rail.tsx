...
const NAV: NavDef[] = [
  { id: "home", label: "How it works", key: "1", icon: <path d="M2 7.5 7.5 2.5 13 7.5V13H9.5V9.5h-4V13H2z" /> },
  { id: "forecast", label: "This quarter's pick", key: "2", icon: <><path d="M2 12.5 6 7l3 3 4-6" /><path d="M2 2v11h11" opacity={0.55} /></> },
  { id: "filings", label: "The filings", key: "3", icon: <><path d="M3.5 1.5h5.5L12 4.5v9H3.5z" /><path d="M5.5 6.5h4M5.5 9h4" opacity={0.7} /></> },
  { id: "backtest", label: "Did it work?", key: "4", icon: <><path d="M2.5 2v11h10" /><path d="M4.5 10.5v-3M7.5 10.5v-6M10.5 10.5v-4.5" strokeLinecap="square" /></> },
];
